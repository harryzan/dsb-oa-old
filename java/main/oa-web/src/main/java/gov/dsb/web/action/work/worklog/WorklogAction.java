package gov.dsb.web.action.work.worklog;

import gov.dsb.core.dao.*;
import gov.dsb.core.domain.SysUser;
import gov.dsb.core.domain.UserAttendance;
import gov.dsb.core.domain.WorkLog;
...
public class WorklogAction extends CRUDActionSupport<WorkLog> {

    @Autowired
    private WorkLogDao service;
    ...
    public String day() throws Exception {
        ...
        worklogs = service.findByQuery("from WorkLog where sysuser.id=? and workdate=? order by starttime", currentUser.getId(), day);
