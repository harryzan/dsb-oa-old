...
<head>
    ...
    <script type="text/javascript">
        function initTree() {
            ...
            //定义树的根节点
            var root = new Ext.tree.AsyncTreeNode({id:'root',text:'数据通道',icon:iconPath + 'root.gif',async:false});


            //构造树面板 ，url="treedata.jsp"定义了异步数据源 .
            var treePanel = new TreePanel(root, null, "data-channel-tree!treedata?treetype=${treetype}", imageUrl, " ");
...
//                wh = wh.substring(0, wh.indexOf("px"));
                ...
                document.getElementById("ext-gen8").scrollTop = top;
            }
...
<a onclick="query(0);" style="cursor:pointer">
    <image title="查找" src="${themesPath}/oldcss/web_icon_021.gif"></image>
</a>
<%--<input type="button" value="查询" class="button_bc" onclick="query(0);" >--%>

<a name="up" onclick="query(-1);" style="cursor:pointer;display:none;">
    <image title="上一个" src="${themesPath}/oldimages/icons/back.gif"></image>
</a>
&nbsp;
<a name="down" onclick="query(1);" style="cursor:pointer;display:none;">
    <image title="下一个" src="${themesPath}/oldimages/icons/next.gif"></image>
</a>
