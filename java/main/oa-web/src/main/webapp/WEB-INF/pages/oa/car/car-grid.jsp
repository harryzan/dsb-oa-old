...
//        var result = doPrivilege(privilegecode);
        var addurl = "car!input";
        var modifyurl = "car!input";
        var deleteurl = "car!delete";
...
//        }
        ...
        var params = {
            ...
            gridParams:[
                ...
                {name:"carmodel",header:"车辆型号",width:"20%"},
                {name:"carlicense",header:"车辆牌照",width:"25%"},
                {name:"buydate",header:"购买日期",width:"20%"}
            ],
