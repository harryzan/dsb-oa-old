...
//        var result = doPrivilege(privilegecode);
        var addurl = "item!input";
        var modifyurl = "item!input";
...
//        }
        ...
        var params = {
            ...
            gridParams:[
                ...
                {name:"name",header:"名称",width:"20%"},
                {name:"model",header:"型号",width:"25%"},
                {name:"unit",header:"单位",width:"20%"},
                {name:"itemcount",header:"结余",width:"20%"}
            ],
