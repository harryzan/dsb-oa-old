...
<head>
    ...
    <script type="text/javascript">
        ...
        function initTree() {
            ...
            var treePanel = new TreePanel(root, null, "multi-data-channel-tree!treedata", imageUrl, " ");
            ...
            if(choose != "" && name != ""){
                ...
                for(var i = 0; i < ids.length; i++){
                    ...
                    str += names[i];
                    str += "<input type='button' class='button_delete' value=' ' onclick='removeNodeFromList(\"channel|<id>" + ids[i] + "</id>\")'/></span><br/></div>";
                    if(divObj.innerHTML == ""){
                        str = "<br/>"+str;
                    }
...
//            });
            ...
            if (ids != "")
            {
                window.returnValue = ids.substring(1, ids.length) + "," +  names.substring(1, names.length);
            } else
            {
