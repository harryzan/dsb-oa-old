...
//            deleteUrl:deleteurl,
            ...
            gridParams:[
                ...
                {name:"item.name",header:"用品名称",width:"20%"},
                {name:"item.model",header:"用品型号",width:"25%"},
                {name:"item.itemcount",header:"用品结余",width:"25%"},
                {name:"user.displayname",header:"申请人",width:"20%"},
                {name:"usecount",header:"申请数量",width:"20%"},
                {name:"submitdate",header:"申请时间",width:"20%"},
