...
<head>
    ...
    <script type="text/javascript">
        function initTree() {
            ...
            //定义树的根节点
            var root = new Ext.tree.AsyncTreeNode({id:'root',text:'监(检)测项目',icon:iconPath + '2_view.gif'});

            //构造树面板 ，url="treedata.jsp"定义了异步数据源 .
            var treePanel = new TreePanel(root, null, "monitor-proj-tree!treedata", imageUrl, " ");
...
//            }
        ...
        function OK(){
            if(returnvalue == undefined){
                Ext.MessageBox.alert("提示", "未选择任何监(检)测项目！");
                return;
            }
